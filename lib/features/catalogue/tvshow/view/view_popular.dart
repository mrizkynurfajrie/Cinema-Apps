...
class ViewPopularTv extends GetView<ControllerTvShow> {
  const ViewPopularTv({super.key});
            ...
            return RefreshIndicator(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Popular TV Shows, prepare your snacks now!',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        horizontalSpace(6.w),
                        Text(
                          'of ${controller.popularTvShow.value.totalPages}',
                          style: TextStyle(
                            fontSize: 12,
                            color: AppColor.neutral.shade700,
                          ),
                      ...
                      children: [
                        ButtonPrimaryOutline(
                          ...
                          onPressed: () async {
                            ...
                            await controller.getPopularTvShow();
                          },
                          label: 'Back',
                        ),
