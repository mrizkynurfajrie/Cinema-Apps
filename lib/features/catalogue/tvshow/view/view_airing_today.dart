...
class ViewAiringTodayTv extends GetView<ControllerTvShow> {
  const ViewAiringTodayTv({super.key});
            ...
            return RefreshIndicator(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Airing Today TV Shows, makes your day',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: controller.listAiringToday.length,
                        itemBuilder: ((context, index) => CardItems(
                              result: controller.listAiringToday[index],
                            )),
                      ),
                    ),
                    verticalSpace(24.h),
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                controller.airingTodayPage.value.toString(),
                                style: TextStyle(
                                  fontSize: 12,
                                  color: AppColor.neutral.shade700,
                                ),
                        ...
                        horizontalSpace(6.w),
                        Text(
                          'of ${controller.airingTodayTvShow.value.totalPages}',
                          style: TextStyle(
                            fontSize: 12,
                            color: AppColor.neutral.shade700,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ButtonPrimaryOutline(
                          ...
                          enable: controller.airingTodayPage.value == 1
                              ? false
                              : true,
                          onPressed: () async {
                            controller.airingTodayPage.value =
                                controller.airingTodayPage.value - 1;
                            await controller.getAiringToday();
                          },
                          label: 'Back',
                        ),
                        ...
                        ButtonPrimary(
                          ...
                          onPressed: () async {
                            controller.airingTodayPage.value =
                                controller.airingTodayPage.value + 1;
                            log('movie page : ${controller.airingTodayPage.value}');
                            await controller.getAiringToday();
                          },
                          label: 'Next',
                        ),
...
class CardItems extends StatelessWidget {
  final AiringTodayTvResult result;
