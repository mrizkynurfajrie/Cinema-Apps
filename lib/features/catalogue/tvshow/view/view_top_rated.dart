...
class ViewTopRatedTv extends GetView<ControllerTvShow> {
  const ViewTopRatedTv({super.key});
            ...
            return RefreshIndicator(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Top Rated TV Shows only for you',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: controller.listTopRated.length,
                        itemBuilder: ((context, index) => CardItems(
                              result: controller.listTopRated[index],
                            )),
                      ),
                    ),
                    verticalSpace(24.h),
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                controller.topRatedPage.value.toString(),
                                style: TextStyle(
                                  fontSize: 12,
                                  color: AppColor.neutral.shade700,
                                ),
                        ...
                        horizontalSpace(6.w),
                        Text(
                          'of ${controller.topRatedTvShow.value.totalPages}',
                          style: TextStyle(
                            fontSize: 12,
                            color: AppColor.neutral.shade700,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ButtonPrimaryOutline(
                          ...
                          enable:
                              controller.topRatedPage.value == 1 ? false : true,
                          onPressed: () async {
                            controller.topRatedPage.value =
                                controller.topRatedPage.value - 1;
                            await controller.getTopRatedTvShow();
                          },
                          label: 'Back',
                        ),
                        ...
                        ButtonPrimary(
                          ...
                          onPressed: () async {
                            controller.topRatedPage.value =
                                controller.topRatedPage.value + 1;
                            log('movie page : ${controller.topRatedPage.value}');
                            await controller.getTopRatedTvShow();
                          },
                          label: 'Next',
                        ),
