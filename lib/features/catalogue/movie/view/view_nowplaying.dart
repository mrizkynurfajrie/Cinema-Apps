...
class ViewNowPlaying extends GetView<ControllerMovie> {
  const ViewNowPlaying({super.key});
            ...
            return RefreshIndicator(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Now playing movies, don't miss it!",
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: controller.listNowPlaying.length,
                        itemBuilder: ((context, index) => CardItems(
                              result: controller.listNowPlaying[index],
                            )),
                      ),
                    ),
                    verticalSpace(24.h),
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                controller.nowPlayingPage.value.toString(),
                                style: TextStyle(
                                  fontSize: 12,
                                  color: AppColor.neutral.shade700,
                                ),
                        ...
                        horizontalSpace(6.w),
                        Text(
                          'of ${controller.nowPlayingMovie.value.totalPages}',
                          style: TextStyle(
                            fontSize: 12,
                            color: AppColor.neutral.shade700,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ButtonPrimaryOutline(
                          ...
                          enable: controller.nowPlayingPage.value == 1
                              ? false
                              : true,
                          onPressed: () async {
                            controller.nowPlayingPage.value =
                                controller.nowPlayingPage.value - 1;
                            await controller.getNowPlayingMovie();
                          },
                          label: 'Back',
                        ),
                        ...
                        ButtonPrimary(
                          ...
                          onPressed: () async {
                            controller.nowPlayingPage.value =
                                controller.nowPlayingPage.value + 1;
                            log('movie page : ${controller.nowPlayingPage.value}');
                            await controller.getNowPlayingMovie();
                          },
                          label: 'Next',
                        ),
