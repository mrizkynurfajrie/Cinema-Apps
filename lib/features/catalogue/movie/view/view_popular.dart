...
class ViewPopular extends GetView<ControllerMovie> {
  const ViewPopular({super.key});
            ...
            return RefreshIndicator(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Popular movies, people favorite',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        horizontalSpace(6.w),
                        Text(
                          'of ${controller.popularMovie.value.totalPages}',
                          style: TextStyle(
                            fontSize: 12,
                            color: AppColor.neutral.shade700,
                          ),
                      ...
                      children: [
                        ButtonPrimaryOutline(
                          ...
                          onPressed: () async {
                            ...
                            await controller.getPopularMovie();
                          },
                          label: 'Back',
                        ),
