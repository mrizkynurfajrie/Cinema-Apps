...
class ViewTopRatedMovie extends GetView<ControllerMovie> {
  const ViewTopRatedMovie({super.key});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        horizontalSpace(6.w),
                        Text(
                          'of ${controller.topRatedMovie.value.totalPages}',
                          style: TextStyle(
                            fontSize: 12,
                            color: AppColor.neutral.shade700,
                          ),
                      ...
                      children: [
                        ButtonPrimaryOutline(
                          ...
                          onPressed: () async {
                            ...
                            await controller.getTopRatedMovie();
                          },
                          label: 'Back',
                        ),
